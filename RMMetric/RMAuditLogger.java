...
import org.apache.hadoop.yarn.server.resourcemanager.metrics.ResourceManagerMetrics;
...
public class RMAuditLogger {
  ...
  public static ResourceManagerMetrics rmm = ResourceManagerMetrics.create("resourcemanager");
